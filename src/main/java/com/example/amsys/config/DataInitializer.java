...
public class DataInitializer implements ApplicationRunner {
    ...
    private List<User> createInitialUsers() {
        return Arrays.asList(
            createUser("T22001", (byte) 4, "秋山", "政人", "あきやま", "まさと", "T22001"),
            createUser("T22002", (byte) 4, "秋山", "祐二", "あきやま", "ゆうじ", "T22002"),
            createUser("T22004", (byte) 4, "伊倉", "旦陽", "いぐら", "あさひ", "T22004"),
            createUser("T22005", (byte) 4, "泉", "陽翔", "いずみ", "はると", "T22005"),
            createUser("T22006", (byte) 4, "勝又", "夢叶", "かつまた", "ゆうと", "T22006"),
            createUser("T22008", (byte) 4, "岸本", "真征", "きしもと", "しんせい", "T22008"),
            createUser("T22010", (byte) 4, "小林", "輝流", "こばやし", "ひかる", "T22010"),
            createUser("T22011", (byte) 4, "酒井", "竣", "さかい", "しゅん", "T22011"),
            createUser("T22012", (byte) 4, "三瓶", "航太郎", "さんぺい", "こうたろう", "T22012"),
            createUser("T22013", (byte) 4, "杉山", "紘生", "すぎやま", "ひろき", "T22013"),
            createUser("T22014", (byte) 4, "鈴木", "颯太", "すずき", "そうた", "T22014"),
            createUser("T22015", (byte) 4, "鈴木", "陽大", "すずき", "ひなた", "T22015"),
            createUser("T22016", (byte) 4, "武井", "風樹", "たけい", "ふうき", "T22016"),
            createUser("T22017", (byte) 4, "山上", "結史", "やまがみ", "ゆうし", "T22017"),
            createUser("T22018", (byte) 4, "山口", "瀬奈", "やまぐち", "せな", "T22018"),
     ...
     * ユーザーオブジェクトを作成
     */
    private User createUser(String userId, Byte gradeCode, String lastName, String firstName, 
